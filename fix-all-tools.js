// Quick Tool Fix Script - Fix CSS and Icons
const fs = require('fs');
const path = require('path');

// List of all tool files to fix
const toolFiles = [
  'age-calculator.html',
  'base64.html', 
  'bmi-calculator.html',
...
// Professional template with correct CSS paths
const template = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>TOOL_NAME - Professional Educational Tools | EduTools</title>
  <meta name="description" content="TOOL_DESCRIPTION - Free, secure, and instant professional tool.">
...
<body class="bg-gray-50 text-gray-800">
    ...
    <div class="container">
      <div class="tool-header-content">
        <div class="tool-breadcrumb">
          ...
          <span class="breadcrumb-current">TOOL_NAME</span>
        </div>
        ...
        <div class="tool-info">
          ...
          <div class="tool-details">
            <h1 class="tool-title">TOOL_NAME</h1>
            <p class="tool-description">TOOL_DESCRIPTION</p>
            <div class="tool-meta">
              <span class="tool-category">TOOL_CATEGORY</span>
        ...
        <div class="tool-main">
          <div class="tool-card">
            <div class="tool-card-header">
              <h2 class="tool-card-title">TOOL_NAME</h2>
            ...
            <div class="tool-card-body">
              <div class="text-center py-12">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-4">TOOL_NAME</h3>
                <p class="text-gray-600 mb-8 max-w-2xl mx-auto">TOOL_DESCRIPTION</p>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      console.log('TOOL_NAME initialized');
...
toolFiles.forEach(file => {
  const config = toolConfigs[file];
  if (config) {
    let content = template
      .replace(/TOOL_NAME/g, config.name)
      .replace(/TOOL_DESCRIPTION/g, config.description)
      .replace(/TOOL_CATEGORY/g, config.category)
      .replace(/TOOL_ICON/g, config.icon);
...
console.log('All tool pages have been fixed with proper CSS and icons!');
